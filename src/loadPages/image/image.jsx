        	...
        	<div className="container-fluid">
        	  <div className="row mb-2">
        	    <div className="col-sm-12">
        	      <h1 className="m-0 text-dark">The Image Body</h1>
        	    </div>
        	  </div>
        	</div>
        </div>
...
class CardGorup extends Component{
  constructor(props){
    ...
    this.state = {
      audioMemeCard: [
        {id: 1, imgTitle: 'Card title 1', imgSrc: ImgMist, imgDesc: 'desc 1', imgUpdate: 'Last updated 1 mins ago'},
        {id: 2, imgTitle: 'Card title 2', imgSrc: ImgNature, imgDesc: 'desc 2', imgUpdate: 'Last updated 2 mins ago'},
        {id: 3, imgTitle: 'Card title 3', imgSrc: ImgOcean, imgDesc: 'desc 3', imgUpdate: 'Last updated 3 mins ago'},
        {id: 4, imgTitle: 'Card title 4', imgSrc: ImgOcean, imgDesc: 'desc 4', imgUpdate: 'Last updated 4 mins ago'},
        {id: 5, imgTitle: 'Card title 5', imgSrc: ImgOcean, imgDesc: 'desc 5', imgUpdate: 'Last updated 5 mins ago'}
      ],
    };
  }

  render(){
    let subCard = this.state.audioMemeCard.map((itemObj, index) => {
      return(
        <SubCardGroup key={itemObj.id} ImgTitle={itemObj.imgTitle} ImgSrc={itemObj.imgSrc} ImgDesc={itemObj.imgDesc} ImgUpdate={itemObj.imgUpdate} />
      );
    });
