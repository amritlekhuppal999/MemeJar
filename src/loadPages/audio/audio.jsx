        	...
        	<div className="container-fluid">
        	  <div className="row mb-2">
        	    <div className="col-sm-12">
        	      <h1 className="m-0 text-dark">The Audio Body</h1>
        	    </div>
        	  </div>
        	</div>
        </div>
...
class CardGorup extends Component{
  constructor(props){
    ...
    this.state = {
      audioMemeCard: [
        {imgTitle: 'Audio Card 1', imgSrc: ImgMist, imgDesc: 'desc 1', imgUpdate: 'Last updated 1 mins ago'},
        {imgTitle: 'Audio Card 2', imgSrc: ImgNature, imgDesc: 'desc 2', imgUpdate: 'Last updated 2 mins ago'},
        {imgTitle: 'Audio Card 3', imgSrc: ImgOcean, imgDesc: 'desc 3', imgUpdate: 'Last updated 3 mins ago'},
        {imgTitle: 'Audio Card 4', imgSrc: ImgOcean, imgDesc: 'desc 4', imgUpdate: 'Last updated 4 mins ago'},
        {imgTitle: 'Audio Card 5', imgSrc: ImgOcean, imgDesc: 'desc 5', imgUpdate: 'Last updated 5 mins ago'}
      ],
    };
  }
